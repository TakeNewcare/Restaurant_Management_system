...
namespace CM.View
{
    public partial class fkmKitchenView : Form
    {
        public fkmKitchenView()
        {
            InitializeComponent();
        }


        private void fmKitchenView_Load(object sender, EventArgs e)
        {
            GetOrders();
        }
        ...
        private void GetOrders()
        {
            ...
            string qry1 = @"select * from tblMain where status = '주문 완료'";
        ...
        private void b_click(object sender, EventArgs e)
        {
            ...
            if (guna2MessageDialog1.Show("주문한 요리가 홀로 나갔나요?") == DialogResult.Yes)
            {
                string qry = @"update tblMain set status = '요리 완료' where MainID = @ID";
                ...
                if (MainClass.SQL(qry, ht) > 0)
                {
                    ...
                    guna2MessageDialog1.Show("요리 완료");
